...
setwd("~/Dropbox/Research/AbbVie/Treatment_effect/R code/SIM_R1_code/1_Sim_uncond/")
...
out.mat = matrix(unlist(out.vec),nrow = n.itt, ncol=12, byrow = TRUE)
...
write.csv(final.out.mat, paste0(scen.all.ind, "_results_", n.itt, ".csv"))
}
